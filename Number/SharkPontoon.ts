...
export function shark__og(pontoonDistance: number, sharkDistance: number, youSpeed: number, sharkSpeed: number, dolphin: boolean): string {
    const dolphinDistraction = 2;
    const sharkTime: number = dolphin ? sharkDistance / (sharkSpeed / dolphinDistraction) : sharkDistance / sharkSpeed;
    const swimTime: number = pontoonDistance / youSpeed; 
