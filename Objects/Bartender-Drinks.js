...
exports.getDrinkByProfession = exports.getDrinkByProfession_obj = exports.getDrinkByProfession_og = void 0;
function getDrinkByProfession_og(pro) {
...
exports.getDrinkByProfession_og = getDrinkByProfession_og;
//refactored
var drinks = {
    "jabroni": "Patron Tequila",
    "school counselor": "Anything with Alcohol",
...
function getDrinkByProfession_obj(profession) {
    return drinks[profession.toLowerCase()] || "Beer";
}
exports.getDrinkByProfession_obj = getDrinkByProfession_obj;
var params = {};
